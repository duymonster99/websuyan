    ...
    <div class="contact-container">
        ...
        <div class="contact-lienhe">
            <div class="contact-left">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.2343556177266!2d106.71586447495783!3d10.79335448935645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752926c8354f21%3A0x2eb92902690110fd!2sTi%E1%BA%BFng%20Trung%20SuYan!5e0!3m2!1sen!2s!4v1686304599951!5m2!1sen!2s" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            ...
            <div class="contact-right">
                <div class="contact-frame70">
                    ...
                    <div class="contact-frame27">
                        <input type="text" class="form-control contact-text30 bg-transparent" placeholder="Tên">
                    </div>
                    <div class="contact-frame28">
                        <input type="email" class="form-control contact-text32 bg-transparent" placeholder="Email">
                    </div>
                    <div class="contact-frame29">
                        <input type="tel" class="form-control contact-text34 bg-transparent" placeholder="Số điện thoại">
                    </div>
                    <div class="contact-frame30">
                        <textarea type="text" class="form-control contact-text36 bg-transparent" placeholder="Câu hỏi của bạn"></textarea>
                    </div>
